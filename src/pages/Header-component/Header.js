      ...
      <div className="center">
        <div className="main-search">
          ...
          <div className="searchbar">
            <form>
              <label htmlFor="some">
                <AiOutlineSearch className={commerce.customer.isLoggedIn() ? 'search-icon-logined' : 'search-icon'} />
              </label>
              <input
                ref={input}
                id="some"
                className={commerce.customer.isLoggedIn() ? 'search-input-logined' : 'search-input'}
                type="text"
